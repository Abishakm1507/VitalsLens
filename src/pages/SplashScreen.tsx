...
const SplashScreen = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-[390px] h-[844px] bg-card rounded-[40px] shadow-elevated overflow-hidden relative border-8 border-foreground/10 flex flex-col items-center justify-center">
